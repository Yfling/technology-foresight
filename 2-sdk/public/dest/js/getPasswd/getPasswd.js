(function(){
    ...
    var $getPasswdMod = $("#getPasswd");
    var $telInput = $getPasswdMod.find('.tel-wrap input');
    var $errMsgMod = $("#errMsg");
    var $verifyBtn = $getPasswdMod.find(".verify-btn");
    var verifyCode = '';
    ...
    function bindEvent(){
        $getPasswdMod.on('tap', '.verify-btn', function(){
